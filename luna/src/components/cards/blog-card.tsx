...
export function BlogCard({ 
  ...
  if (variant === 'latest') {
    return <BlogCardLatest post={post} index={index} detailsHref={detailsHref} {...other} />;
  }
  ...
  return (
    <Card sx={sx} {...other}>
      ...
      <CardContent sx={{ pt: showAuthor ? 6 : 3 }}>
...
function BlogCardLatest({ post, index, detailsHref }: { 
  post: BlogCardData; 
  index: number; 
  detailsHref: string;
}) {
...
type InfoBlockProps = BoxProps & Pick<BlogCardData, 'totalViews' | 'totalShares' | 'totalComments'>;
